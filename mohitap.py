...
with open('trainedbyM_model.pkl', 'rb') as model_file:
    trained_model = pickle.load(model_file)

st.title('Titanic Survival Prediction Created by Mohit')
...
survival_dict={1:"Badhai Ho!! Aap Zinda Rhege", 0:"Better Luck Next Time"}
